      ...
      <section class="titleS text-center container">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            ...
            <p class="lead text-muted">Disponibles en la tienda física</p>
          </div>
        </div>
      </section>
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
              <div class="card shadow-sm">
                <img src="images/productos/producto1.jpg" alt="Corte" class="img-fluid">
              </div>
            </div>
            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto2.jpg" alt="Corte" class="img-fluid">
                
              </div>
            </div>
            <div class="col">
              <div class="card shadow-sm">
                <img src="images/productos/producto3.jpg" alt="Corte" class="img-fluid">
               </div>
            </div>

            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto4.jpg" alt="Corte" class="img-fluid">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto5.jpg" alt="Corte" class="img-fluid">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto6.jpg" alt="Corte" class="img-fluid">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto7.jpg" alt="Corte" class="img-fluid">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto8.jpg" alt="Corte" class="img-fluid">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="images/productos/producto9.jpg" alt="Corte" class="img-fluid">
